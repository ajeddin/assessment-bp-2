...
class Ticket {
    ...
    updateStatus(newStatus){
        ...
        console.log(`The order for customer ${this,this.customerId} is
        now ${this.status}.`);
    }
}
/*
...
//CODE HERE
let firstTicket = new Ticket( 'pizza, bread, and soda','3:04 PM','Richard')
...
//CODE HERE
firstTicket.updateStatus('Finished')
console.log(firstTicket);
